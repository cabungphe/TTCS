            ...
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-4" action="" method="POST">
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="exampleInputEmail1" name="usermail" placeholder="User Email">
                    <i class="mdi mdi-account"></i>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputUsername">User Name</label>
                    <input type="text" class="form-control" id="exampleInputUsername" name="username" placeholder="User Name">
                    <i class="mdi mdi-account"></i>
                  </div>
                  <div class="form-group">
